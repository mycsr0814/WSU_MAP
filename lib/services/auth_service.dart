...
class AuthService {
  static const String baseUrl = 'http://3.24.110.21:3001/user';
  ...
  static Future<AuthResult> register({
    ...
    try {
      ...
      switch (response.statusCode) {
        ...
        default:
          return AuthResult.failure('알 수 없는 오류가 발생했습니다. (${response.statusCode})');
      }
    } catch (e) {
  ...
  static Future<LoginResult> login({
    ...
    try {
      ...
      switch (response.statusCode) {
        ...
        default:
          return LoginResult.failure('알 수 없는 오류가 발생했습니다. (${response.statusCode})');
      }
    } catch (e) {
  ...
  /// 로그아웃 API 호출
  static Future<AuthResult> logout({
    required String id,
  }) async {
    try {
