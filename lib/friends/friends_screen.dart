...
class _FriendsScreenState extends State<FriendsScreen>
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildDetailRow(Icons.badge, AppLocalizations.of(context)!.id, friend.userId),
                  const SizedBox(height: 16),
                  _buildDetailRow(
                    Icons.phone,
                    AppLocalizations.of(context)!.contact,
                    friend.phone.isEmpty ? AppLocalizations.of(context)!.noContactInfo : friend.phone,
                  ),
                  const SizedBox(height: 16),
                  _buildDetailRow(
                    Icons.location_on,
                        ...
                        if (!isLocationDisplayed) ...[
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              label: Text(AppLocalizations.of(context)!.showLocation),
 ...
 Future<void> _removeFriendLocationFromMap(Friend friend) async {
  try {
    ...
    _showSuccessMessage(AppLocalizations.of(context)!.friendLocationRemoved(friend.userName));

    debugPrint('✅ 친구 위치 제거 완료: ${friend.userName}');
  } catch (e) {
    debugPrint('❌ 친구 위치 제거 오류: $e');
    _showErrorMessage(AppLocalizations.of(context)!.errorCannotRemoveLocation);
  }
}

  /// 친구 위치 표시 성공 메시지
void _showFriendLocationSuccess(Friend friend) {
  _showSuccessMessage(AppLocalizations.of(context)!.friendLocationShown(friend.userName));
}
  ...
  try {
    ...
    if (controller.errorMessage == null) {
      _showSuccessMessage(AppLocalizations.of(context)!.friendRequestSent(id));
      _addController.clear();
      setModalState?.call(() {});
    } else {
      _showErrorMessage(controller.errorMessage ?? AppLocalizations.of(context)!.errorAddFriend);
    }
  } catch (e) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        AppLocalizations.of(context)!.friendManagementAndRequests,
                        style: const TextStyle(
                          fontSize: 14,
                          color: Colors.grey,
                          fontWeight: FontWeight.w500,
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 6),
                Text(
                  AppLocalizations.of(context)!.realTimeSyncStatus(controller.lastUpdateTime),
                  style: TextStyle(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                const SizedBox(width: 4),
                                Text(AppLocalizations.of(context)!.sentRequestsCount(controller.sentFriendRequests.length)),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                const SizedBox(width: 4),
                                Text(AppLocalizations.of(context)!.receivedRequestsCount(controller.friendRequests.length)),
                  ...
                  Expanded(
                    child: TabBarView(
                      children: [
                        ...
                        _buildReceivedRequestsTab(setModalState, scrollController),
                      ],
                    ),
                  ),
                ],
    ...
    children: [
      if (controller.friendRequests.isNotEmpty) ...[
        Container(
          ...
          child: Row(
            children: [
              Icon(Icons.notifications_active, color: Colors.red.shade600, size: 16),
              const SizedBox(width: 8),
              Expanded(
                child: Text(
                  AppLocalizations.of(context)!.newFriendRequests(controller.friendRequests.length),
                  style: TextStyle(
          ...
          child: Column(
            ...
            children: [
              ...
              if (request.requestDate.isNotEmpty) ...[
                const SizedBox(height: 4),
                Text(
                  AppLocalizations.of(context)!.requestDate(request.requestDate),
                  style: const TextStyle(
                    color: Color(0xFF64748B),
                    fontSize: 12,
                  ),
  ...
  final confirmed = await showDialog<bool>(
    ...
    builder: (context) => AlertDialog(
      ...
      content: Text(
        AppLocalizations.of(context)!.cancelFriendRequestConfirm(request.toUserName),
  ...
  if (confirmed == true) {
    ...
    setModalState?.call(() {});
    _showSuccessMessage(AppLocalizations.of(context)!.friendRequestCanceled(request.toUserName));
  }
}
...
Widget _buildFriendsContent() {
  return Container(
    ...
    child: Column(
      children: [
        _buildSectionHeader(
          AppLocalizations.of(context)!.friendCount(controller.friends.length),
