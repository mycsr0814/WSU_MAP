...
class _ProfileScreenState extends State<ProfileScreen> with TickerProviderStateMixin {
  ...
  Widget _buildUserInfoCard(BuildContext context, UserAuth userAuth, AppLocalizations l10n) {
    return Container(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(userAuth.currentUserIcon, size: 28, color: Colors.white),
          ),
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(16),
              border: Border.all(color: isDestructive ? Colors.red.withOpacity(0.2) : const Color(0xFFE2E8F0)),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  height: 44,
                  decoration: BoxDecoration(
                    color: isDestructive ? Colors.red.withOpacity(0.1) : const Color(0xFF1E3A8A).withOpacity(0.1),
                    borderRadius: BorderRadius.circular(12),
                  ),
                  child: Icon(icon, size: 22, color: isDestructive ? Colors.red[600] : const Color(0xFF1E3A8A)),
                ),
                const SizedBox(width: 16),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(title, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: isDestructive ? Colors.red[600] : const Color(0xFF1E293B))),
                      const SizedBox(height: 4),
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text(l10n.delete_feature_in_progress),
            ],
          ),
          backgroundColor: const Color(0xFF1E3A8A),
